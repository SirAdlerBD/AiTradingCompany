...
| 2 | The loop: trader, risk rules in code, gate, shadow ledger, stops, time stop | Any decision reconstructible from the DB (`desk decisions`); shadow book marked daily against the benchmark for two weeks | Built, observing |
